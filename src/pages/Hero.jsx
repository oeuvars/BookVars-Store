        ...
        <div class="min-w-screen min-h-screen lg:flex items-center justify-center primary-background" >
            ...
            <div class=" flex mx-auto justify-center items-center lg:w-3/6 phone:pt-5 phone:pb-7 lg:pb-0 lg:pt-0s">
                <div class="flex flex-col gap-5">
                    ...
                    <p class="font-marcellus font-medium lg:text-lg phone:text-base lg:text-cyan-100 phone:paragraph-text phone:text-center lg:text-start w-5/6 flex mx-auto">Ignite your imagination at our online bookstore—curated literary treasures, personalized recommendations, and seamless delivery. Enter a world of endless possibilities and let your reading journey begin.</p>
